...
public class GLView extends GLSurfaceView {
    ...
    public GLView(Context context) {
        ...
        im.setType(ImageData.TYPE_ASSERTS);
        im.setPath("argame00.jpg");

        helloAR = new HelloAR(getContext(), im);
        ImageRecognition imageRecognition = new ImageRecognition(getContext());
        imageRecognition.setAR(helloAR);
        setRenderer(imageRecognition);
